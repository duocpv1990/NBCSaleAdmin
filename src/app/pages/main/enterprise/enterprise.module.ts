...
@NgModule({
  declarations: [EnterpriseComponent, EnterpriseListComponent, EnterpriseCreateComponent,
    DeleteEnterpriseComponent, CertificateEnterpriseComponent, EnterpriseEditComponent],
  imports: [
    CommonModule,
    FilterBaseModule,
    TableBaseModule,
